...
//    mTextPaint = new TextPaint(TextPaint.FILTER_BITMAP_FLAG);
  ...
  @Override public void draw(Canvas canvas) {
    Log.d(TAG, "draw: entrydraw");
    Log.d(TAG, "draw: heigth"+mTextRect.height());
    Log.d(TAG, "draw: width"+mTextRect.width());
    ...
    Log.d(TAG, "draw: canvasheigth"+canvas.getHeight());
    Log.d(TAG, "draw: canvaswidth"+canvas.getWidth());
...
//    final int availableWidthPixels = mTextRect.width();
    ...
    final int availableHeightPixels = getHeight() - 5 - 5;

    final int availableWidthPixels = getWidth() -5 - 5;
    Log.d(TAG, "resizeText: availableHeightPixels"+availableHeightPixels);
    Log.d(TAG, "resizeText: availableWidthPixels"+availableWidthPixels);
